...
<div id="page" class="hfeed site container">
	<header id="masthead" class="site-header row <?php voltata_header_alignment(); ?>" role="banner">
      ...
      <?php endif; ?>
		...
		<div id="second-animation" class="wow animated <?php echo get_theme_mod( 'voltata_header_two_animation' ); ?>" data-wow-delay="<?php echo get_theme_mod( 'voltata_header_two_animation_delay' ); ?>s">
			...
			<div id="mobile-site-navigation" class="main-navigation row" role="navigation">
				<div class="col-md-12">
					...
					<?php else : ?>
						<p class="no-menu">No <b>Primary Menu</b> assigned!<br>Head over to <b>Appearance</b> > <b>Menus</b> and assign a <b>Primary Menu</b>.</p>
					<?php endif; ?>
				</div>
	...
	<div id="second-animation-image" class="wow animated <?php echo get_theme_mod( 'voltata_header_two_animation' ); ?>" data-wow-delay="<?php echo get_theme_mod( 'voltata_header_two_animation_delay' ); ?>s">
		<?php if ( get_header_image() && get_theme_mod( 'voltata_header_display_type' ) != 1 ) : ?>  
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
				<img src="<?php header_image(); ?>" width="<?php echo esc_attr( get_custom_header()->width ); ?>" height="<?php echo esc_attr( get_custom_header()->height ); ?>" alt="<?php echo( get_bloginfo( 'title' ) ); ?>" class="img-header">
			</a>
