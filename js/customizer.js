...
( function( $ ) {
	...
	// Body text color.
	wp.customize( 'voltata_muted_font_color', function( value ) {
		value.bind( function( to ) {
			$('.muted, .muted a, .muted a time, .comment-metadata time, .wp-caption-text, #fp-first-part .entry-date, #fp-second-part .entry-date, .widget_recent_entries .post-date, .widget_recent_post_with_thumb .post-date').css( 'color', to );
		} );
	} );
