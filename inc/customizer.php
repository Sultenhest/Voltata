...
function voltata_customize_register( $wp_customize ) {
	...
	$wp_customize->get_control( 'header_textcolor' )->description = __('Select the color of the site name and tagline.', 'voltata');
	$wp_customize->get_setting( 'background_color' )->default     = '#ffffff';
	$wp_customize->get_control( 'background_color' )->description = __('Select the background color for the site.', 'voltata');
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'voltata_nav_color', array(
		  'description' => __( 'Select which color you want to use for the menu links.' , 'voltata'),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'voltata_font_color', array(
		  'description' => __( 'Select which color you want for the body text.' , 'voltata'),
	    'label'       => __( 'Body Text Color', 'voltata' ),
	    'section'     => 'colors',
	    'settings'    => 'voltata_font_color',
  )));
	
	//  =============================
	//  = 1.3 Muted Body Text Color       =
	//  =============================
	$wp_customize->add_setting('voltata_muted_font_color', array(
			'default'           => '#666666',
		  'transport'         => 'postMessage',
		  'sanitize_callback' => 'sanitize_hex_color',
	));
	
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'voltata_muted_font_color', array(
		  'description' => __( 'Select which color you want for the muted body text (like the date, tags, categories or number of comments).' , 'voltata'),
	    'label'       => __( 'Muted Text Color', 'voltata' ),
	    'section'     => 'colors',
	    'settings'    => 'voltata_muted_font_color',
  )));
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'voltata_link_color', array(
		  'description' => __( 'Select which color you want for the body text links.' , 'voltata'),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'voltata_link_hover_color', array(
		  'description' => __( 'Select which color you want for the body text links on mouse over.' , 'voltata'),
	...
	//  ====================================
	//  = 1.6 Mobile Menu Background Color =
	//  ====================================
	...
	$wp_customize->add_control( 'voltata_mobile_background_colors', array(
			'description'    => __('Select which color template for the menu, when shown on mobile devices.', 'voltata'),
		  'label'          => __('Mobile menu background color', 'voltata'),
			'section'        => 'colors',
  ...
  $wp_customize->add_control('voltata_header_display_type', array(
	...
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'voltata_logo_image', array(
		  'description' => __('Please note that if you run WordPress v4.5 or newer, you are required to use the logo uploader found here in the Customizer, but under the Site Identity section.', 'voltata'),
...
function voltata_customize_css()
{
  ...
  <style type="text/css">
    ...
    body{ font-family: '<?php echo $body_font; ?>', 'Helvetica', 'Arial', sans-serif; }
		.no-menu, .no-menu a{ color:<?php echo get_theme_mod('voltata_link_color', '#333333'); ?>; }
    ...
    #content .entry-content a, #content .entry-content a:visited{ color:<?php echo get_theme_mod('voltata_link_color', '#333333'); ?>; }
    #content .entry-content a:hover{ color:<?php echo get_theme_mod('voltata_link_hover_color', '#333333'); ?>; }
    ...
    .muted, .muted a, .muted a time,
    .comment-metadata time, .wp-caption-text,
    #fp-first-part .entry-date, #fp-second-part .entry-date,
    .widget_recent_entries .post-date,
    .widget_recent_post_with_thumb .post-date{ color:<?php echo get_theme_mod('voltata_muted_font_color', '#666666'); ?>; }
